...
public static void printElementsExceptStartsWithE(List <String> myList){
    ...
    // bir listin icinde veren method'u olusturunuz. (list return edecek)
    public static List<String> getElementLengthMoreThanFiveWithUpperCase(List<String> myList){
       return myList.
                stream().
                filter(t->t.length()>5).
                map(t->t.toUpperCase()).
                collect(Collectors.toList()); // collect methoduyla collectionu liste ve başka collectionlara çevirebiliriz
    ...
    public static void printElementsDistinctWithUpperCaseSorted(List<String> myList){
        myList.
                stream().
                distinct().
                map(t->t.toUpperCase()).
...
public static void printElementsUniqueLowerCaseSortByLength(List<String> myList){
        myList.
                stream().
                distinct().
                map(t->t.toLowerCase()).
