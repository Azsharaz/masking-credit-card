...
public enum Cities {
    ...
    // enum dışında oluşturduklarımızı kullanmayacağız o yüzden private yaptık
    // değiştirilemez olduğu için final dedik
    // enumdan new keywordü ile obje oluşturamayız
