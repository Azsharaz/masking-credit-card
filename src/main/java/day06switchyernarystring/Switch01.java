...
public class Switch01 {
    public static void main(String[] args) {
        ...
        System.out.println("LÜTFEN BAŞLANGIÇ AYININ KAÇINCI AY OLDUĞUNU GİRİNİZ.");
        ...
        /*
        switch condition parantezine
        1) String
        2) int
        3) byte
        4) short
        5)Char da kullanabiliriz.

        switch condition parantesine
        1) long
        2) boolean
        3) float
        4) double kullanılmaz.
         */
